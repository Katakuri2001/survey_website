...
heroCtaSurvey: 'Start Survey',
    ...
    townshipCodeLabel: 'Township Code',
    nrcType: 'Type',
    nrcPlaceholder: '123456',
    nrcExample: 'e.g. 14/HATHATA (N)361920',
    nrcPreview: 'NRC Preview',
    selectStateFirst: 'Select State/Region first',
    selectStateForTownship: 'Select a State/Region to see townships',
    valid: 'Valid',
  ...
  my: {
    ...
    productAndaman: 'အန္တမာန် လှင်လှase & Refreshing',
...
nrc: 'မှတ်ပုံတင်နံပါတ်',
    ...
    townshipCodeLabel: 'မြို့နယ်ကုဒ်',
    nrcType: 'အမျိုးအစား',
    nrcPlaceholder: '၁၂၃၄၅၆',
    nrcExample: 'ဥပမာ - ၁၄/HATHATA (N)361920',
    nrcPreview: 'NRC အန Tempelhein',
    selectStateFirst: 'တိုင်းဒေသကြီး/ပြည်နယ်ကို ရွေးချယ်ပါ',
    selectStateForTownship: 'မြို့နယ်ကုဒ်များကို ကြည့်ရန် တိုင်း�ဒေသကြီး/ပြည်နယ်ကို ရွေးချယ်ပါ',
    valid: 'ကျန့်',
