    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-yellow-600 text-white">
      <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="/login" className="px-8 py-4 bg-yellow-500 rounded-full font-semibold text-lg text-blue-900 hover:bg-yellow-400 transition-all transform hover:scale-105 shadow-lg shadow-yellow-500/30">
            {t('startSurvey')}
          </a>
          <a href="/login" className="px-8 py-4 bg-white/10 backdrop-blur border border-white/20 rounded-full font-semibold text-lg hover:bg-white/20 transition-all flex items-center justify-center gap-2">
