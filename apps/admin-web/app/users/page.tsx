...
function UserDetailPanel({
  ...
  useEffect(() => {
    // Justification: detail fetch keyed to userId — loading/results are intentionally reset when the route param changes.
...
export default function UsersPage() {
  ...
  useEffect(() => {
    // Justification: list fetch keyed to page + search — loading/results are intentionally reset when they change.
    // eslint-disable-next-line react-hooks/set-state-in-effect
    fetchUsers()
  }, [fetchUsers])
      ...
      <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="relative">
          <button
            ...
            disabled={exporting}
            className="inline-flex items-center gap-2 rounded-xl bg-stout-500 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-stout-600 disabled:cursor-not-allowed disabled:opacity-60"
          >
